  ...
  .controller('serviceCtrl', function($scope,$http,$rootScope,$location) {
      ...
      $scope.editService = function(id_service){
          var httpRequest = $http({              
              ...
              console.log(data);
              console.log(data.servicePrice.businessDay);
              var tmp = data.servicePrice.businessDay.split(";");
              ...
              var month = "";
              var year = "";
              var date_from = new Date(data.servicePrice.d_from);
              ...
              var date_to = new Date(data.servicePrice.d_to);
              ...
              data.servicePrice.d_from = from;
              data.servicePrice.d_to = to;
              console.log(data);
