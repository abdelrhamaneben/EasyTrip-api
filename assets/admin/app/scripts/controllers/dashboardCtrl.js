      ...
      $scope.loadStats = function() {
          ...
          var httpRequest = $http({
            ...
            $scope.lineVisite = {
              ...
              series: [ '# visites' , '# recherches de services'],
              data: [
                  [
                       datar.nbvisit90d,
                       datar.nbvisit75d,
            ...
            $scope.lineInscription = {
              labels: ['90j', '75j', '60j', '45j', '30j', '15j', '7j'],
              series: [ '# inscriptions utilisateurs', '# inscriptions business'],
              data: [
                  [
                      datar.nbsignupnu90d,
                      datar.nbsignupnu75d,
            ...
            $scope.lineService = {
              labels: ['90j', '75j', '60j', '45j', '30j', '15j', '7j'],
              series: [ '# nouveaux services', '# nouvelles promos'],
              data: [
                  [
                      datar.nbservice90d,
                      datar.nbservice75d,
